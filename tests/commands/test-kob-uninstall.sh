...
function kob_execute {
  ...
  TODO: - [ ] kob uninstall --environment ${ kob_environment_under_test } --namespace ${ kob_test_namespace }. ---> output file.
...
function kob_verify {   
   ...
   TODO: - [ ] Call function __test_kobman_$(environment_under_name)_ validate_uninstall( optional arguments) --> output file.
   TODO: - [ ] Check Output log file.
...
function kob_cleanup {
    ...
    TODO: - [ ] Remove function __test_kobman_$(environment_under_name)_ validate_uninstall().
